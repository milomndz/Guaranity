    ...
    sintactico() {
        switch (this.tokenActual) {
            ...
            case "ifTok":
                ...
                if (this.tokenActual == "(") {
                    this.tokenActual = this.ToksTable[++this.posicion];
                    if (this.tokenActual == "identificador" ||
...
module.exports = __webpack_require__(/*! D:\Documents\UCA\TEO\Guaranity\Guaranity\guaranity-ide\src\main.ts */"./src/main.ts");
